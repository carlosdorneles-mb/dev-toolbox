...
| `devstack-info`         | shell | `devstack-info <ambiente> [app]` - mostra detalhes de um deployment no Kubernetes (namespace, env, versão, quem/quando fez o último deploy). Com `gum` instalado e o app omitido, abre um seletor com os deployments do namespace. Requer `kubectl` configurado. Ver [`shell/devstack-info/README.md`](shell/devstack-info/README.md).                                                                                                                                                                                                                                                              |
...
| `devstack-users`        | shell | `devstack-users [namespace] [filtro]` - navega usuários/subwallets/saldos do devstack via port-forward MySQL/PostgreSQL num namespace Kubernetes, em fzf interativo (`CTRL-E` edita dados/saldo). Requer `kubectl` (contexto devstack), `psql`, `mysql`. Ver [`shell/devstack-users/README.md`](shell/devstack-users/README.md).                                                                                                                                                                                                                                                                    |
| `devstack-rollout-crash-pods` | shell | `devstack-rollout-crash-pods [ambiente]` - reinicia (`kubectl rollout restart`) deployments com pods em crash/erro ou `Running` com READY incompleto num namespace, com confirmação e modo `watch` opcional ao final. Requer `kubectl` configurado. Ver [`shell/devstack-rollout-crash-pods/README.md`](shell/devstack-rollout-crash-pods/README.md).                                                                                                                                                                                                                                              |
