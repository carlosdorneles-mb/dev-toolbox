...
| `--no-warning` | silencia os avisos em stderr (base de PR desatualizada, branch deletada, cadeia truncada, base divergente do histórico local etc) - só a cadeia em si |
